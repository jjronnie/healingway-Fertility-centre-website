...
return [
    ...
    /*
     * App-specific flag: delete originals after required conversions (webp/thumb) are generated.
     * Originals are removed intentionally for storage savings.
     * For existing media, run: php artisan media-library:regenerate --only=webp
     */
    'delete_original_file_after_conversions' => true,
     ...
     */
    'path_generator' => App\Support\Media\OrganizedPathGenerator::class,
