...
return [
    ...
    'title' => [
         ...
         */
        'suffix' => ' | HealingWay Fertility Centre',
    ...
    'description' => [
        'fallback' => 'HealingWay Fertility Centre is a trusted IVF and fertility clinic in Bugolobi, Kampala, Uganda, offering advanced reproductive and fertility care.',
    ],


    'image' => [
        'fallback' => 'assets/img/1.webp',
    ],


    'author' => [
        'fallback' => 'HealingWay Fertility Centre',
    ],


    'twitter' => [
        '@username' => 'HealingWayUG',
    ],
