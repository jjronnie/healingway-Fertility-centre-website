    ...
    <nav x-data="{ open: false, scrolled: false }" @scroll.window="scrolled = (window.pageYOffset > 10)"
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center py-4">
                ...
                <!-- Desktop Navigation -->
                <div class="hidden md:flex items-center text-center space-x-8 text-lg font-medium " x-cloak>
                ...
                <!-- Mobile Menu Button -->
                <button @click="open = !open" class="md:hidden p-2   duration-300" x-cloak>
