      ...
      <div class="relative mt-32">
          ...
          <footer class="bg-hw-blue text-white pt-96 md:pt-72 relative z-10">
              <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                  ...
                  <div class="border-t border-gray-500 mt-12 pt-8 pb-8 text-center">
                      <p>Copyright &copy; {{ date('Y') }} HealingWay Fertility Center | All rights reserved. | Website by <a class="text-hw-green hover:text-white" href="https://techtowerinc.com" target="_blank">TechTower Inc</a> </p>
                  </div>
          ...
          <section
              ...
              <div class="bg-hw-green shadow-lg rounded-2xl py-16 px-6 text-center">
