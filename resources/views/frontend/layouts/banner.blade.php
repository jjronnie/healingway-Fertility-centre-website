  <section id="home"
        ...
        <div class="absolute inset-0 z-0">
            <div
                class="absolute inset-0 bg-cover bg-center transition-opacity duration-1000 ease-in-out slideshow-image">
            </div>
        ...
        <div
            ...
            <div
                ...
                <div class="text-4xl font-bold counter text-hw-green" data-target="15">0</div>
                <div class="text-white/80 text-sm sm:text-base mt-2">Years Experience</div>
            </div>
            <div
                class="bg-white/10 backdrop-blur-lg p-6 rounded-2xl text-center transform transition duration-500 hover:scale-105 hover:bg-white/20 shadow-md">
                <div class="text-4xl font-bold counter text-hw-green" data-target="5000">0</div>
                <div class="text-white/80 text-sm sm:text-base mt-2">Happy Families</div>
            </div>
            <div
                class="bg-white/10 backdrop-blur-lg p-6 rounded-2xl text-center transform transition duration-500 hover:scale-105 hover:bg-white/20 shadow-md">
                <div class="text-4xl font-bold counter text-hw-green" data-target="85">0</div>
                <div class="text-white/80 text-sm sm:text-base mt-2">Success Rate</div>
            </div>
            <div
                class="bg-white/10 backdrop-blur-lg p-6 rounded-2xl text-center transform transition duration-500 hover:scale-105 hover:bg-white/20 shadow-md">
                <div class="text-4xl font-bold counter text-hw-green" data-target="50">0</div>
