            ...
            <div class="grid lg:grid-cols-2 gap-16 items-center">
                ...
                <div>
                    ...
                    <p class="text-lg text-gray-600 mb-6 leading-relaxed">
                        HealingWay Fertility Centre was established with one clear mission: to bring hope and solutions
                        to individuals and couples facing challenges in starting a family. From the very beginning, our
                        focus has been on combining medical expertise with compassionate care.
                    </p>
                    <p class="text-lg text-gray-600 mb-6 leading-relaxed">
                        Over the years, we have supported thousands of families on their journey to parenthood. Our team
                        of experienced specialists provides a wide range of advanced fertility treatments, supported by
                        modern technology and continuous research in reproductive medicine.
                    </p>
                    <p class="text-lg text-gray-600 mb-8 leading-relaxed">
                        Today, HealingWay Fertility Centre is recognized as a trusted destination for fertility care. We
                        pride ourselves on offering personalized treatment plans, emotional support, and a welcoming
                        environment that ensures every patient feels valued and understood throughout their journey.
                    </p>
                ...
                <div class="space-y-6">
                    <div
                        class="bg-white p-8 rounded-2xl shadow-lg hover:shadow-2xl transition-all hover:-translate-y-2">
            ...
            <div class="grid lg:grid-cols-3 gap-12">
                ...
                <div class="text-center">
                    ...
                    <p class="text-gray-600 leading-relaxed">
                        To provide world-class fertility care with compassion, helping every family achieve their dream
                        of parenthood. </p>
                </div>
                ...
                <div class="text-center">
                    ...
                    <p class="text-gray-600 leading-relaxed">
                        To be the leading fertility center, setting new standards in reproductive medicine and patient
                        care. </p>
                </div>
