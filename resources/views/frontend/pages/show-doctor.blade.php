        ...
        <div class=" p-8 md:p-12">
            <div class="flex flex-col md:flex-row items-center md:items-start space-y-8 md:space-y-0 md:space-x-8">
                ...
                <div class="text-center md:text-left flex-grow w-full md:w-2/3 lg:w-3/4">
                    <h1 class="text-4xl sm:text-5xl font-extrabold text-gray-900 mb-2 leading-tight">{{ $doctor->name }}</h1>
                    <p class="text-xl sm:text-1xl text-blue-600 font-semibold mb-6">{{ $doctor->position }}</p>
                    <div class="prose lg:prose-xl text-gray-700 max-w-none">
                        <p>{{ $doctor->body ?? 'No detailed information available yet for this doctor.' }}</p>
                    </div>
                </div>
            </div>
