    ...
    <nav class="mt-8">
        ...
        <div class="space-y-1 px-4">
            ...
            <a href="{{ route('admin.staff.index') }}"
                class="flex items-center space-x-3 px-3 py-2 rounded-lg transition-colors {{ request()->routeIs('admin.staff.*') ? 'bg-white text-hw-blue font-semibold' : 'hover:bg-hw-blue' }}">
            ...
            <a href="{{ route('admin.users.index') }}"
                class="flex items-center space-x-3 px-3 py-2 rounded-lg transition-colors {{ request()->routeIs('admin.users.*') ? 'bg-white text-hw-blue font-semibold' : 'hover:bg-hw-blue' }}">
                <i data-lucide="users" class="w-5 h-5"></i>
                <span>Users</span>
            </a>
